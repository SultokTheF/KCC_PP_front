...
const FormulaEditor = ({ value, onChange, existingFormulas = [] }) => {
  ...
  const allowedVariables = [
    ...
    'Pred_T', 'Wo_Prov_T', 'W_Prov_T', 'W_Prov_P3', 'W_Prov_P3_Gen', 'W_Prov_F1', 'W_Prov_F1_Gen', 'W_Prov_F2', 'W_Prov_F2_Gen', 
    'BE_T', 'OD_T', 'T_Coef', 'plan_t', 'direction', 
    'coefficient', 'volume', 'coefficient_Gen', 'volume_Gen',
    'subject_name', 'subject_type', 'subject_bin', 'object_name', 'provider_name'
  ];
